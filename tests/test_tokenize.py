...
tok3 = [['ð i', 'ð ə'], ['b eɪ ʒ'], ['h j u'], ['ɑ n', 'ɔ n'], ['ð i', 'ð ə'], ['ˈw ɔ t ə r z'], ['ə v'], ['ð i', 'ð ə'], ['l ɑ k'], ['ˌɪ m ˈp r ɛ s t'],
    ['ɔ l'], ['ˌɪ n ˈk l u d ɪ ŋ'], ['ð i', 'ð ə'], ['f r ɛ n ʧ'], ['k w i n'], ['b ɪ ˈf ɔ r', 'ˌb i ˈf ɔ r'], ['ʃ i'], ['h ə r d'], ['ð æ t', 'ð ə t'],
...
tok6 = [['ð iː', 'ð ə'], ['b e‍ɪ ʒ'], ['h j u'], ['ɑ n', 'ɔː n'], ['ð iː', 'ð ə'], ['ˈw ɔ t ə r z'], ['ə v'], ['ð iː', 'ð ə'], ['l ɑ k'], ['ˌɪ m ˈp r e s t'],
    ...
    ['ˈs ɪ m f ə n iː'], ['ə ˈg e‍ɪ n', 'ə ˈg e n'], ['d‍ʒ ə s t', 'd‍ʒ ɪ s t'], ['æ z', 'ɛ z'], ['j ə ŋ'], ['ˈɑ r θ ə r'], ['ˈw ɔː n t ɪ d']]
